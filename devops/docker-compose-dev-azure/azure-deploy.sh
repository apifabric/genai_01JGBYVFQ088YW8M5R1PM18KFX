...
resourcename="dogwalkingpaymentsystem"  # lower case, only
resourcegroup="dogwalkingpaymentsystem_rg"
...
# git clone https://github.com/apilogicserver/dogwalkingpaymentsystem.git
# cd dogwalkingpaymentsystem
...
az group create --name dogwalkingpaymentsystem_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group dogwalkingpaymentsystem_rg --sku S1 --is-linux
az container create --resource-group dogwalkingpaymentsystem_rg --name dogwalkingpaymentsystem --image apilogicserver/dogwalkingpaymentsystem:latest --dns-name-label dogwalkingpaymentsystem --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//dogwalkingpaymentsystem.westus.azurecontainer.io:5656'
